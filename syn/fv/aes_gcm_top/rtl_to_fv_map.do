...
# Generated by Genus(TM) Synthesis Solution 21.17-s066_1, revision 1.568
# Generated on: Mon Oct 13 03:02:26 PDT 2025 (Mon Oct 13 10:02:26 UTC 2025)
...
set logfile fv/aes_gcm_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aes_gcm_top -revised fv_map
...
set env(RC_VERSION)     "21.17-s066_1"
set env(CDN_SYNTH_ROOT) "/opt/cadence/installs/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/opt/cadence/installs/GENUS211/tools.lnx86"
set env(CW_DIR) "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/opt/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
add_search_path ../rtl ../rtl/third_party/secworks_aes/src/rtl . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/aes_gcm_top.v
elaborate_design -golden -root {aes_gcm_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/aes_gcm_top/fv_map.v.gz
elaborate_design -revised -root {aes_gcm_top}
...
set_system_mode lec
write_compared_points noneq.compared_points.aes_gcm_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aes_gcm_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aes_gcm_top.rtl.fv_map.rpt
