...
catch { set_db clock_gating_min_flops 4 }
...
# 3) (Optional but helpful) specify clock transition to avoid ideal 0ps slew
catch { set_clock_transition 0.05 [get_clocks $CLK_NAME] } ;# 50 ps
...
set SAIF_PATH  "../waves/aes_gcm_top.saif"
set VCD_PATH   "../waves/aes_gcm_top.vcd"
set TOP_INST   "/aes_gcm_top"          ;
